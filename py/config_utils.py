...
class Config:
    ...
    def PrintHelpMessage(self):
        ...
        print('python PatchWorkPlot.py -i INPUT_CONFIG.CSV -o OUTPUT_DIR {OPTIONAL ARGUMENTS}')
        print('input.csv: a configuration file containing information about input sequences in the CSV/TSV format.')
        print('\b')
        print('--------OPTIONAL ARGUMENTS----------')
        print('----------ALigner options-----------')
        print('--aligner NAME: choosen aligner. Avaliable options: lastz (default), yass, minimap2, mashmap, custom.')
        ...
        print('--reverse-cmap BOOLEAN: reverse colormap. Default: True')
        ...
        print('--lwidth INT: the width of lines showing alignments on the final plot. Default: 1')
        ...
        print('--hide-legend: if true, then the legend will not be added to the plot')
        ...
        print('--bp-min-len INT: minimum length of the alignment to frame with lines. Default: 10000')
        print('--bp-lwidth INT: the width of lines framing the alignemnt breakpoints. Default: 0.2')
